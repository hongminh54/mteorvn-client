...
import meteordevelopment.meteorvnclient.events.render.ArmRenderEvent;
import meteordevelopment.meteorvnclient.events.render.HeldItemRendererEvent;
...
public abstract class HeldItemRendererMixin {
    ...
    private void onRenderItem(AbstractClientPlayerEntity player, float tickDelta, float pitch, Hand hand, float swingProgress, ItemStack item, float equipProgress, MatrixStack matrices, VertexConsumerProvider vertexConsumers, int light, CallbackInfo ci) {
        MeteorVNClient.EVENT_BUS.post(HeldItemRendererEvent.get(hand, matrices));
    }
    ...
    private void onRenderArm(AbstractClientPlayerEntity player, float tickDelta, float pitch, Hand hand, float swingProgress, ItemStack item, float equipProgress, MatrixStack matrices, VertexConsumerProvider vertexConsumers, int light, CallbackInfo ci) {
        MeteorVNClient.EVENT_BUS.post(ArmRenderEvent.get(hand, matrices));
    }
