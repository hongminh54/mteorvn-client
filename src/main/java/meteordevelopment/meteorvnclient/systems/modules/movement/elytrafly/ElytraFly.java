...
package meteordevelopment.meteorvnclient.systems.modules.movement.elytrafly;
...
import meteordevelopment.meteorvnclient.systems.modules.movement.elytrafly.modes.Bounce;
import meteordevelopment.meteorvnclient.systems.modules.movement.elytrafly.modes.Packet;
import meteordevelopment.meteorvnclient.systems.modules.movement.elytrafly.modes.Pitch40;
import meteordevelopment.meteorvnclient.systems.modules.movement.elytrafly.modes.Vanilla;
import meteordevelopment.meteorvnclient.systems.modules.player.ChestSwap;
import meteordevelopment.meteorvnclient.systems.modules.player.Rotation;
...
public class ElytraFly extends Module {
    ...
    protected void enableGroundListener() {
        MeteorVNClient.EVENT_BUS.subscribe(staticGroundListener);
    }

    protected void disableGroundListener() {
        MeteorVNClient.EVENT_BUS.unsubscribe(staticGroundListener);
    }
    ...
    protected void enableInstaDropListener() {
        MeteorVNClient.EVENT_BUS.subscribe(staticInstadropListener);
    }

    protected void disableInstaDropListener() {
        MeteorVNClient.EVENT_BUS.unsubscribe(staticInstadropListener);
    }
