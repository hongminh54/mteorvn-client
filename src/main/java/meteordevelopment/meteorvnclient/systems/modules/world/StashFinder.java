...
import meteordevelopment.meteorvnclient.gui.widgets.containers.WVerticalList;
...
public class StashFinder extends Module {
    ...
    public StashFinder() {
        super(Categories.World, "stash-finder", "Searches loaded chunks for storage blocks. Saves to <your minecraft folder>/meteorvn-client");
    }
    ...
    private File getJsonFile() {
        return new File(new File(new File(MeteorVNClient.FOLDER, "stashes"), Utils.getFileWorldName()), "stashes.json");
    }

    private File getCsvFile() {
        return new File(new File(new File(MeteorVNClient.FOLDER, "stashes"), Utils.getFileWorldName()), "stashes.csv");
    }
