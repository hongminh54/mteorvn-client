...
import meteordevelopment.meteorvnclient.mixin.ShulkerBoxScreenHandlerAccessor;
...
public class HighwayBuilder extends Module {
    ...
    private enum State {
        ...
        DefuseCrystalTraps {
             ...
             *
             * @see meteordevelopment.meteorvnclient.mixin.MinecraftClientMixin#wrapStopUsing(ClientPlayerInteractionManager, PlayerEntity)
             */
            @Override
            protected void tick(HighwayBuilder b) {
                if (cooldown > 0) {
