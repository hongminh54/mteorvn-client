...
import meteordevelopment.meteorvnclient.utils.notebot.instrumentdetect.InstrumentDetectMode;
...
public class Notebot extends Module {
    ...
    public void playRandomSong() {
        File[] files = MeteorVNClient.FOLDER.toPath().resolve("notebot").toFile().listFiles();
