...
import meteordevelopment.meteorvnclient.systems.modules.render.Chams;
...
public class ChamsShader extends EntityShader {
    ...
    public ChamsShader() {
        MeteorVNClient.EVENT_BUS.subscribe(ChamsShader.class);
    }
    ...
    public static void load() {
        try {
            ...
            for (String fileFormat : FILE_FORMATS) {
                Optional<Resource> optional = mc.getResourceManager().getResource(MeteorVNClient.identifier("textures/chams." + fileFormat));
