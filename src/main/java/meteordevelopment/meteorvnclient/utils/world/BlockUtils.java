...
package meteordevelopment.meteorvnclient.utils.world;
...
import meteordevelopment.meteorvnclient.systems.modules.player.InstantRebreak;
...
public class BlockUtils {
    ...
    public static void init() {
        MeteorVNClient.EVENT_BUS.subscribe(BlockUtils.class);
    }
