...
package meteordevelopment.meteorvnclient.utils.misc.input;
...
public class KeyBinds {
    ...
    public static KeyBinding OPEN_GUI = new KeyBinding("key.meteorvn-client.open-gui", InputUtil.Type.KEYSYM, GLFW.GLFW_KEY_RIGHT_SHIFT, CATEGORY);
    public static KeyBinding OPEN_COMMANDS = new KeyBinding("key.meteorvn-client.open-commands", InputUtil.Type.KEYSYM, GLFW.GLFW_KEY_PERIOD, CATEGORY);
