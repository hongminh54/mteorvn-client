...
import meteordevelopment.meteorvnclient.mixin.*;
import meteordevelopment.meteorvnclient.mixininterface.IMinecraftClient;
import meteordevelopment.meteorvnclient.settings.StatusEffectAmplifierMapSetting;
...
import meteordevelopment.meteorvnclient.utils.world.BlockEntityIterator;
import meteordevelopment.meteorvnclient.utils.world.ChunkIterator;
...
public class Utils {
    ...
    public static void init() {
        MeteorVNClient.EVENT_BUS.subscribe(Utils.class);
    }
    ...
    public static byte[] readBytes(InputStream in) {
        try {
            ...
            MeteorVNClient.LOG.error("Error reading from stream.", e);
            return new byte[0];
        } finally {
