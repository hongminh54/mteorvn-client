...
import meteordevelopment.meteorvnclient.gui.renderer.operations.TextOperation;
import meteordevelopment.meteorvnclient.gui.renderer.packer.GuiTexture;
import meteordevelopment.meteorvnclient.gui.renderer.packer.TexturePacker;
import meteordevelopment.meteorvnclient.gui.widgets.WWidget;
import meteordevelopment.meteorvnclient.renderer.GL;
import meteordevelopment.meteorvnclient.renderer.Renderer2D;
...
import meteordevelopment.meteorvnclient.utils.render.ByteTexture;
...
import static meteordevelopment.meteorvnclient.utils.Utils.getWindowHeight;
...
public class GuiRenderer {
    ...
    public static void init() {
        CIRCLE = addTexture(MeteorVNClient.identifier("textures/icons/gui/circle.png"));
        TRIANGLE = addTexture(MeteorVNClient.identifier("textures/icons/gui/triangle.png"));
        EDIT = addTexture(MeteorVNClient.identifier("textures/icons/gui/edit.png"));
        RESET = addTexture(MeteorVNClient.identifier("textures/icons/gui/reset.png"));
        FAVORITE_NO = addTexture(MeteorVNClient.identifier("textures/icons/gui/favorite_no.png"));
        FAVORITE_YES = addTexture(MeteorVNClient.identifier("textures/icons/gui/favorite_yes.png"));
